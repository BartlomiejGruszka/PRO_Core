    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "8c457d6f-65c9-49d4-97ab-c5306ea1f713", "Admin", "ADMIN" },
                    { 3, "b4800b19-6586-46ef-9a5f-c6cce84980b7", "Moderator", "MODERATOR" },
                    { 2, "be7dad64-6743-4608-aa3d-ca567df82b75", "Author", "AUTHOR" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 0, "397099b8-9228-42bf-b751-6e97fcd9101a", null, "c@c.pl", true, null, true, true, true, null, "C@C.PL", "STEFAN", "AQAAAAEAACcQAAAAEG6cNJRSVylV3/tdiHn5UVECZMhhvHP7hT3fVxqTRzhpU9OJReOkZoHisfkoLk5W7Q==", null, false, new DateTime(2021, 3, 19, 23, 30, 54, 0, DateTimeKind.Unspecified), "6GTDRNU4VTDMTYWX7U66A57BT6ACCR3E", false, "Stefan" },
                    { 5, 0, "6931d766-59a6-42a4-9c40-3593ea2bdd4a", null, "b@b.pl", true, null, true, true, true, null, "A@A.PL", "ANDRZEJ", "AQAAAAEAACcQAAAAEG6cNJRSVylV3/tdiHn5UVECZMhhvHP7hT3fVxqTRzhpU9OJReOkZoHisfkoLk5W7Q==", null, false, new DateTime(2021, 3, 19, 23, 43, 35, 0, DateTimeKind.Unspecified), "XDQ77TTJDPKOJKPRKF6HKYC6Y7P2BCBN", false, "Andrzej" },
                    { 2, 0, "0e5dabda-21e1-41c3-9ca9-712557e18cb8", null, "moderator@a.pl", true, null, true, true, true, null, "MODERATOR@A.PL", "MODERATOR", "AQAAAAEAACcQAAAAEG6cNJRSVylV3/tdiHn5UVECZMhhvHP7hT3fVxqTRzhpU9OJReOkZoHisfkoLk5W7Q==", null, false, new DateTime(2021, 3, 19, 23, 30, 37, 0, DateTimeKind.Unspecified), "7DVGRSDTJBFLREA3JWKP5652YSSE65BW", false, "Moderator" },
                    { 1, 0, "b780211e-49f4-4497-bc8b-8c2830668bfd", null, "a@a.pl", true, null, true, true, true, null, "A@A.PL", "ADMIN", "AQAAAAEAACcQAAAAEG6cNJRSVylV3/tdiHn5UVECZMhhvHP7hT3fVxqTRzhpU9OJReOkZoHisfkoLk5W7Q==", null, false, new DateTime(2021, 3, 19, 23, 29, 50, 0, DateTimeKind.Unspecified), "NLKT3KRF6FZYJAKJBSI5JY5I3GSMNOFT", false, "Admin" },
                    { 3, 0, "9aa3cb54-abbf-44df-88ad-442c79613fb5", null, "author@a.pl", true, null, true, true, true, null, "AUTHOR@A.PL", "AUTHOR", "AQAAAAEAACcQAAAAEG6cNJRSVylV3/tdiHn5UVECZMhhvHP7hT3fVxqTRzhpU9OJReOkZoHisfkoLk5W7Q==", null, false, new DateTime(2021, 3, 19, 23, 30, 20, 0, DateTimeKind.Unspecified), "TVMXT4TOQHJQYEPBI66U4Y6N5R2PN4BS", false, "Author" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1991, 1, 1, 17, 0, 0, 0, DateTimeKind.Unspecified), "Jan", true, "Kowalski" },
                    { 3, new DateTime(1991, 1, 1, 17, 0, 0, 0, DateTimeKind.Unspecified), "Adam", true, "Nowak" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1991, 1, 1, 17, 0, 0, 0, DateTimeKind.Unspecified), true, null },
                    { 2, new DateTime(1991, 1, 1, 17, 0, 0, 0, DateTimeKind.Unspecified), true, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(2012, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 3, "Kupić", 1 },
                    ...
                    { 2, new DateTime(2012, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 2, "Kiepskie", 1 },
                    ...
                    { 1, new DateTime(2012, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 1, "Dobre", 1 },
                    { 4, new DateTime(2012, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), true, 4, "Gram", 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 15, "Mimo kilku małych problemów nie przeszkodziło mi to z cieszenia się z gry. Przez 6 godzin grania musiałem wczytać checkpoint tylko raz przez jednego buga. Nowe patche mogą pomóc z optymalizacją więc polecam na nie czekać ( Patch 1.04 właśnie wiele problemów z optymalizacją naprawił )", null, 1, 10, 5, null, 6, new DateTime(2016, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 7, 1 },
