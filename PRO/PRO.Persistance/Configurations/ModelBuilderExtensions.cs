       ...
       //static CultureInfo culture = CultureInfo.GetCultureInfo("pl-PL");
        ...
        public static void SeedApplicationUsers(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicationUser>().HasData(
              new ApplicationUser
              {
                  ...
                  RegisterDate = DateTime.ParseExact("19/03/2021 23:29:50", "dd/MM/yyyy HH:mm:ss", culture),
                  EditDate = null,
                  Description = null,
                  IsActive = true,
                  IsPublic = true,
               ...
               new ApplicationUser
               {
                   ...
                   RegisterDate = DateTime.ParseExact("19/03/2021 23:30:37", "dd/MM/yyyy HH:mm:ss", culture),
                   EditDate = null,
                   Description = null,
                   IsActive = true,
                   IsPublic = true,
                ...
                new ApplicationUser
                {
                    ...
                    RegisterDate = DateTime.ParseExact("19/03/2021 23:30:20", "dd/MM/yyyy HH:mm:ss", culture),
                    EditDate = null,
                    Description = null,
                    IsActive = true,
                    IsPublic = true,
                 ...
                 new ApplicationUser
                 {
                     ...
                     RegisterDate = DateTime.ParseExact("19/03/2021 23:30:54", "dd/MM/yyyy HH:mm:ss", culture),
                     EditDate = null,
                     Description = null,
                     IsActive = true,
                     IsPublic = true,
                  ...
                  new ApplicationUser
                  {
                      ...
                      RegisterDate = DateTime.ParseExact("19/03/2021 23:43:35", "dd/MM/yyyy HH:mm:ss", culture),
                      EditDate = null,
                      Description = null,
                      IsActive = true,
                      IsPublic = true,
        ...
        public static void SeedModerators(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Moderator>().HasData(
                new Moderator { UserId = 1, CreatedDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), LastLoginDate = null, IsActive = true },
                new Moderator { UserId = 2, CreatedDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), LastLoginDate = null, IsActive = true }
        ...
        public static void SeedAuthors(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>().HasData(
                new Author { UserId = 1, FirstName = "Jan", LastName = "Kowalski", CreatedDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Author { UserId = 3, FirstName = "Adam", LastName = "Nowak", CreatedDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true }
                );
        }
        ...
        public static void SeedCompanies(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Company>().HasData(
                new Company { Id = 1, Name = "Electronic Arts", CreatedDate = DateTime.ParseExact("27/05/1982 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 2, Name = "Bioware", CreatedDate = DateTime.ParseExact("01/02/1995 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 3, Name = "Ubisoft", CreatedDate = DateTime.ParseExact("12/03/1986 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 4, Name = "Ubisoft Montreal", CreatedDate = DateTime.ParseExact("26/04/1997 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 5, Name = "Nintendo", CreatedDate = DateTime.ParseExact("23/09/1889 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 6, Name = "Gamefreak", CreatedDate = DateTime.ParseExact("26/04/1989 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 7, Name = "Activision", CreatedDate = DateTime.ParseExact("01/10/1979 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 8, Name = "Blizzard", CreatedDate = DateTime.ParseExact("08/02/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 9, Name = "Treyarch", CreatedDate = DateTime.ParseExact("01/01/1996 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 10, Name = "Infinity Ward", CreatedDate = DateTime.ParseExact("01/05/2002 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 11, Name = "CD Projekt Red", CreatedDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 12, Name = "Firaxis Games", CreatedDate = DateTime.ParseExact("01/05/1996 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 13, Name = "Take-Two Interactive", CreatedDate = DateTime.ParseExact("30/09/1993 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 14, Name = "Microsoft", CreatedDate = DateTime.ParseExact("04/04/1975 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 15, Name = "Sony", CreatedDate = DateTime.ParseExact("07/05/1946 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true },
                new Company { Id = 16, Name = "Square Enix", CreatedDate = DateTime.ParseExact("07/05/1955 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true }
        ...
        public static void SeedPlatforms(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Platform>().HasData(
                new Platform { Id = 1, Name = "Xbox 360", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 14 },
                new Platform { Id = 2, Name = "Xbox One", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 14 },
                new Platform { Id = 3, Name = "Xbox Series X", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 14 },
                new Platform { Id = 4, Name = "Switch", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 5 },
                new Platform { Id = 5, Name = "3DS", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 5 },
                new Platform { Id = 6, Name = "Playstation 3", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 15 },
                new Platform { Id = 7, Name = "Playstation 4", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 15 },
                new Platform { Id = 8, Name = "Playstation 5", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 15 },
                new Platform { Id = 9, Name = "PC ", ReleaseDate = DateTime.ParseExact("01/01/1994 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), IsActive = true, CompanyId = 14 }
        ...
        public static void SeedGames(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Game>().HasData(
                new Game
                {
                    ...
                    ReleaseDate = DateTime.ParseExact("01/01/2007 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                    IsActive = true,
                    PlatformId = 9,
                    StatusId = 5,
                    GenreId = 1,
                ...
                new Game
                {
                    ...
                    ReleaseDate = DateTime.ParseExact("06/01/2010 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                    IsActive = true,
                    PlatformId = 9,
                    StatusId = 5,
                    GenreId = 1,
                ...
                new Game
                {
                    ...
                    ReleaseDate = DateTime.ParseExact("06/03/2012 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                    IsActive = true,
                    PlatformId = 9,
                    StatusId = 5,
                    GenreId = 1,
                 ...
                 new Game
                 {
                     ...
                     ReleaseDate = DateTime.ParseExact("06/11/2007 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                     IsActive = true,
                     PlatformId = 1,
                     StatusId = 5,
                     GenreId = 6,
                  ...
                  new Game
                  {
                      ...
                      ReleaseDate = DateTime.ParseExact("17/11/2009 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                      IsActive = true,
                      PlatformId = 1,
                      StatusId = 5,
                      GenreId = 6,
                   ...
                   new Game
                   {
                       ...
                       ReleaseDate = DateTime.ParseExact("15/11/2019 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                       IsActive = true,
                       PlatformId = 4,
                       StatusId = 1,
                       GenreId = 1,
                    ...
                    new Game
                    {
                        ...
                        ReleaseDate = DateTime.ParseExact("17/11/2019 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                        IsActive = true,
                        PlatformId = 9,
                        StatusId = 2,
                        GenreId = 4,
                     ...
                     new Game
                     {
                         ...
                         ReleaseDate = DateTime.ParseExact("09/10/2021 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                         IsActive = true,
                         PlatformId = 7,
                         StatusId = 1,
                         GenreId = 4,
                      ...
                      new Game
                      {
                          ...
                          ReleaseDate = DateTime.ParseExact("17/11/2022 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                          IsActive = true,
                          PlatformId = 1,
                          StatusId = 6,
                          GenreId = 6,
                       ...
                       new Game
                       {
                           ...
                           ReleaseDate = DateTime.ParseExact("17/11/2021 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                           IsActive = true,
                           PlatformId = 7,
                           StatusId = 1,
                           GenreId = 1,
                        ...
                        new Game
                        {
                         ...
                         new Game
                         {
                             ...
                             ReleaseDate = DateTime.ParseExact("17/12/2021 17:00:00", "dd/MM/yyyy HH:mm:ss", culture),
                             IsActive = true,
                             PlatformId = 3,
                             StatusId = 1,
                             GenreId = 6,
        ...
        public static void SeedAwards(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Award>().HasData(
                new Award { Id = 1, Name = "Gra roku 2007", AwardDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), GameId = 1 },
                new Award { Id = 2, Name = "Gra roku 2010", AwardDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), GameId = 2 },
                new Award { Id = 3, Name = "Gra roku 2012", AwardDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), GameId = 3 },
                new Award { Id = 4, Name = "Najlepsza fabuła 2009", AwardDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), GameId = 5 },
                new Award { Id = 5, Name = "Najlepsza fabuła 2012", AwardDate = DateTime.ParseExact("01/01/1991 17:00:00", "dd/MM/yyyy HH:mm:ss", culture), GameId = 3 }
               );
        }
        ...
        public static void SeedUserLists(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<UserList>().HasData(
                new UserList { Id = 1, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Dobre", IsPublic = true, UserId = 1, ListTypeId = 1 },
                new UserList { Id = 2, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Kiepskie", IsPublic = true, UserId = 1, ListTypeId = 2 },
                new UserList { Id = 3, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Kupić", IsPublic = true, UserId = 1, ListTypeId = 3 },
                new UserList { Id = 4, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Gram", IsPublic = true, UserId = 1, ListTypeId = 4 },
                new UserList { Id = 5, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Ukończone", IsPublic = true, UserId = 2, ListTypeId = 1 },
                new UserList { Id = 6, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Porzucone", IsPublic = true, UserId = 2, ListTypeId = 2 },
                new UserList { Id = 7, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Planowane", IsPublic = true, UserId = 2, ListTypeId = 3 },
                new UserList { Id = 8, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Ukończone", IsPublic = true, UserId = 4, ListTypeId = 1 },
                new UserList { Id = 9, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Porzucone", IsPublic = true, UserId = 4, ListTypeId = 2 },
                new UserList { Id = 10, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Ukończone", IsPublic = true, UserId = 5, ListTypeId = 1 },
                new UserList { Id = 11, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Porzucone", IsPublic = true, UserId = 5, ListTypeId = 2 },
                new UserList { Id = 12, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Planowane", IsPublic = true, UserId = 5, ListTypeId = 3 },
                new UserList { Id = 13, CreatedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), Name = "Grane", IsPublic = true, UserId = 5, ListTypeId = 4 }
        ...
        public static void SeedGameLists(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<GameList>().HasData(
                new GameList { Id = 1, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 9, PersonalScore = 8, UserListId = 1, GameId = 1, EditedDate = null },
                new GameList { Id = 2, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 15, PersonalScore = 9, UserListId = 1, GameId = 2, EditedDate = null },
                new GameList { Id = 3, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 26, PersonalScore = 5, UserListId = 2, GameId = 10, EditedDate = null },
                new GameList { Id = 4, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 24, PersonalScore = 4, UserListId = 4, GameId = 8, EditedDate = null },
                new GameList { Id = 5, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 17, PersonalScore = 6, UserListId = 4, GameId = 9, EditedDate = null },
                new GameList { Id = 6, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 12, PersonalScore = 8, UserListId = 5, GameId = 1, EditedDate = null },
                new GameList { Id = 7, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 7, GameId = 1, EditedDate = null },
                new GameList { Id = 8, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 7, GameId = 2, EditedDate = null },
                new GameList { Id = 9, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 7, GameId = 3, EditedDate = null },
                new GameList { Id = 10, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 8, PersonalScore = 1, UserListId = 8, GameId = 7, EditedDate = null },
                new GameList { Id = 11, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 1, PersonalScore = 7, UserListId = 9, GameId = 7, EditedDate = null },
                new GameList { Id = 12, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 3, PersonalScore = 10, UserListId = 9, GameId = 9, EditedDate = null },
                new GameList { Id = 13, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 6, PersonalScore = 10, UserListId = 9, GameId = 8, EditedDate = null },
                new GameList { Id = 14, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 42, PersonalScore = 2, UserListId = 9, GameId = 11, EditedDate = null },
                new GameList { Id = 15, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 15, PersonalScore = 10, UserListId = 9, GameId = 10, EditedDate = null },
                new GameList { Id = 16, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 11, GameId = 11, EditedDate = null },
                new GameList { Id = 17, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 11, GameId = 13, EditedDate = null },
                new GameList { Id = 18, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 11, GameId = 14, EditedDate = null },
                new GameList { Id = 19, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 11, GameId = 10, EditedDate = null },
                new GameList { Id = 20, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 11, GameId = 12, EditedDate = null },
                new GameList { Id = 21, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 0, PersonalScore = null, UserListId = 11, GameId = 3, EditedDate = null },
                new GameList { Id = 22, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 10, PersonalScore = 9, UserListId = 12, GameId = 1, EditedDate = null },
                new GameList { Id = 23, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 20, PersonalScore = 4, UserListId = 12, GameId = 2, EditedDate = null },
                new GameList { Id = 24, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 14, PersonalScore = null, UserListId = 4, GameId = 5, EditedDate = null },
                new GameList { Id = 25, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 52, PersonalScore = 7, UserListId = 8, GameId = 1, EditedDate = null },
                new GameList { Id = 26, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 742, PersonalScore = 9, UserListId = 8, GameId = 2, EditedDate = null },
                new GameList { Id = 27, AddedDate = DateTime.ParseExact("20/02/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), HoursPlayed = 111, PersonalScore = 8, UserListId = 4, GameId = 3, EditedDate = null }
        ...
        public static void SeedArticles(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Article>().HasData(
                new Article { Id = 1, GameId = 1, UserId = 1, ArticleTypeId = 1, ImageId = 25, IsActive = true, PublishedDate = DateTime.ParseExact("15/04/2019 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 2, GameId = 2, UserId = 1, ArticleTypeId = 1, ImageId = 24, IsActive = true, PublishedDate = DateTime.ParseExact("22/08/2019 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 3, GameId = 3, UserId = 1, ArticleTypeId = 1, ImageId = 23, IsActive = true, PublishedDate = DateTime.ParseExact("20/09/2010 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 4, GameId = 4, UserId = 1, ArticleTypeId = 1, ImageId = 22, IsActive = true, PublishedDate = DateTime.ParseExact("27/04/2012 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 5, GameId = 5, UserId = 1, ArticleTypeId = 1, ImageId = 21, IsActive = true, PublishedDate = DateTime.ParseExact("01/02/2016 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 6, GameId = 6, UserId = 1, ArticleTypeId = 2, ImageId = 20, IsActive = true, PublishedDate = DateTime.ParseExact("09/04/2017 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 7, GameId = 8, UserId = 3, ArticleTypeId = 2, ImageId = 19, IsActive = true, PublishedDate = DateTime.ParseExact("21/07/2016 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 8, GameId = 10, UserId = 3, ArticleTypeId = 2, ImageId = 26, IsActive = true, PublishedDate = DateTime.ParseExact("10/10/2017 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 9, GameId = 11, UserId = 3, ArticleTypeId = 2, ImageId = 18, IsActive = true, PublishedDate = DateTime.ParseExact("25/11/2018 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 10, GameId = 12, UserId = 3, ArticleTypeId = 3, ImageId = 17, IsActive = true, PublishedDate = DateTime.ParseExact("15/12/2019 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." },
                new Article { Id = 11, GameId = 13, UserId = 3, ArticleTypeId = 3, ImageId = 16, IsActive = true, PublishedDate = DateTime.ParseExact("11/12/2019 00:00:00", "dd/MM/yyyy HH:mm:ss", culture), SourceLink = "link", Title = "Tytuł artykułu", Preview = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", Content = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book." }
